...
### 1.0.5
    ...
    - fix for a problem when one dependency name has starts with other and resulting example notebook is pulled into mkdocs of the first

    - minor fixes to packaged github workflows
